    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyFrame2 = Keyframe.ofFloat(0.5f, 93);
                Keyframe keyFrame3 = Keyframe.ofFloat(1, 74);
                PropertyValuesHolder holder
                        = PropertyValuesHolder.
                        ofKeyframe("progress", keyFrame1, keyFrame2,keyFrame3);
                ObjectAnimator.ofPropertyValuesHolder(view, holder).setDuration(1500).start();
            }
        });
    }
}
